  ...
  <section class="px-6 pb-12 md:px-12">
    ...
    <div class="grid grid-cols-2 max-[600px]:grid-cols-1 xl:grid-cols-4 gap-x-10 gap-y-8">
        <div class="card bg-base-100 shadow-xl">
            <figure class="px-4 pt-4"><img class="rounded-xl h-56 bg-contain"
                  src="https://images.unsplash.com/photo-1679403766680-9aa2b959417d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
                  alt=""
                  class="h-80"/></figure>
            <div class="card-body">
                <h1 class="card-title">Chat GPT</h2>
                <p>Open AI</p>
            </div>
        </div>
        <div class="card bg-base-100 shadow-xl">
            <figure class="px-4 pt-4"><img class="rounded-xl h-56 bg-contain"
                  ...
                  /></figure>
            <div class="card-body">
                <h1 class="card-title">Instagram</h2>
                <p>Meta Group</p>
            </div>
        </div>
        <div class="card bg-base-100 shadow-xl">
            <figure class="px-4 pt-4"><img class="rounded-xl h-56 bg-contain"
                  src="https://images.unsplash.com/photo-1637592156979-95f44c286423?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1213&q=80"
                  alt=""
                  class="h-80"/></figure>
            <div class="card-body">
                <h1 class="card-title">Telegram</h2>
                <p>Telegram Corp</p>
            </div>
        </div>
        <div class="card bg-base-100 shadow-xl">
            <figure class="px-4 pt-4"><img class="rounded-xl h-56 bg-contain"
                  src="https://images.unsplash.com/photo-1633355444132-695d5876cd00?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1332&q=80"
                  alt=""
                  class="h-80"/></figure>
            <div class="card-body">
                <h1 class="card-title">Figma</h2>
                <p>Figma Inc</p>
            </div>
        </div>
    </div>
